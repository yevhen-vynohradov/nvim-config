...
function M.on_attach(client, buffer)
  ...
  local format = require("plugins.tools.lsp.format").format
  ...
  self:map("<leader>lw", require("plugins.tools.lsp.utils").toggle_diagnostics, { desc = "Toggle Inline Diagnostics" })
end
